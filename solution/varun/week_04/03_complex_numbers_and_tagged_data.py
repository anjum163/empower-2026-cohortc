...
def real_part_polar(tagged_impedance: Impedance) -> float:
  ...
  magnitude = magnitude_polar(tagged_impedance)
  angle = angle_polar(tagged_impedance)
...
def real_part(tagged_impedance: Impedance) -> float:
  ...
  if type_tag(tagged_impedance) == "rectangular":
    ...
    raise ValueError("Invalid impedance type")
...
def add_impedance(first_impedance: Impedance, second_impedance: Impedance) -> Impedance:
  ...
  total_resistance = real_part(first_impedance) + real_part(second_impedance)
  total_reactance = imag_part(first_impedance) + imag_part(second_impedance)
  return make_from_real_imag(total_resistance, total_reactance)
